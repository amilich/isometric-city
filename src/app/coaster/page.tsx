    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex items-center justify-center p-6">
      <div className="max-w-xl w-full text-center space-y-8">
        <div className="space-y-2">
          <T><div className="text-5xl font-light tracking-widest text-white/90">Coaster Park</div></T>
          <T><div className="text-sm text-white/50 uppercase tracking-[0.3em]">Theme Park Tycoon</div></T>
        </div>
        <T>
