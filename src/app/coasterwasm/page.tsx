...
export default function CoasterWasmPage() {
  ...
  const [loadingMessage, setLoadingMessage] = useState('initializing_wasm');
  ...
  const loadingMessages: Record<string, string> = {
    initializing_wasm: gt('Initializing WASM...'),
        ...
        {loading && (
          <T>
            <div className="absolute inset-0 bg-gradient-to-br from-emerald-950 via-teal-950 to-emerald-950 flex flex-col items-center justify-center z-50">
              ...
              <div className="text-white/60 mb-4"><Var>{loadingMessages[loadingMessage]}</Var></div>
