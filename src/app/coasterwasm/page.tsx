...
import { msg, useGT, useMessages, T, Var, Num } from 'gt-next';
        ...
        {loading && (
          <div className="absolute inset-0 bg-gradient-to-br from-emerald-950 via-teal-950 to-emerald-950 flex flex-col items-center justify-center z-50">
            ...
            <div className="text-white/60 mb-4">
              {loadingMessage === 'initializing' && gt('Initializing WASM...')}
              {loadingMessage === 'loading_wasm' && gt('Loading WASM module...')}
              {loadingMessage === 'creating_game' && gt('Creating game...')}
              {loadingMessage === 'loading_sprites' && gt('Loading sprites...')}
              {loadingMessage === 'starting_game' && gt('Starting game loop...')}
            </div>
