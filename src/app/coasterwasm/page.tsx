...
import { T, msg, useMessages, Var, Currency, Num } from 'gt-next';
...
export default function CoasterWasmPage() {
  ...
  const [loadingMessage, setLoadingMessage] = useState(msg('Initializing WASM...'));
  ...
  useEffect(() => {
    ...
    async function init() {
      try {
        setLoadingMessage(msg('Loading WASM module...'));
        ...
        setLoadingMessage(msg('Creating game...'));
        ...
        // Load sprite sheets
        setLoadingMessage(msg('Loading sprites...'));
        ...
        setLoadingMessage(msg('Starting game loop...'));
        ...
        <div className="p-4 border-b border-slate-700 space-y-2">
          <T>
            <div className="flex justify-between text-sm">
              ...
              <span className="text-green-400"><Currency currency="USD">{stats.cash}</Currency></span>
            </div>
          </T>
          <T>
            <div className="flex justify-between text-sm">
        ...
        {loading && (
          <T>
            <div className="absolute inset-0 bg-gradient-to-br from-emerald-950 via-teal-950 to-emerald-950 flex flex-col items-center justify-center z-50">
              ...
              <div className="text-white/60 mb-4"><Var>{m(loadingMessage)}</Var></div>
