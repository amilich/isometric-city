...
export default function CoasterWasmPage() {
  ...
  const loadingMessages: Record<string, string> = {
    ...
    loadingWasm: gt('Loading WASM module...'),
    creating: gt('Creating game...'),
    loadingSprites: gt('Loading sprites...'),
    starting: gt('Starting game loop...'),
  };
  ...
  useEffect(() => {
    ...
    async function init() {
      try {
        ...
        // Load sprite sheets
        setLoadingMessage('loadingSprites');
