    ...
    <div className="relative group">
      ...
      {onDelete && (
        <button
          ...
          className="absolute top-1/2 -translate-y-1/2 right-1.5 p-1.5 opacity-60 sm:opacity-0 sm:group-hover:opacity-100 hover:bg-red-500/20 active:bg-red-500/30 text-white/40 hover:text-red-400 rounded transition-all duration-200"
          title="Delete city"
        >
        ...
        <main className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex flex-col items-center justify-center p-4 safe-area-top safe-area-bottom overflow-y-auto">
          ...
          {savedCities.length > 0 && (
            <div className="w-full max-w-xs mt-4">
              ...
              <div 
                className="flex flex-col gap-2 max-h-48 overflow-y-auto overscroll-contain"
