...
const TOOL_GROUPS: ToolGroup[] = [
  { label: msg('Tools'), tools: ['select', 'path', 'queue_path', 'coaster_track', 'bulldoze', 'water'] },
  { label: msg('Scenery'), tools: ['scenery_tree', 'scenery_flower'] },
  { label: msg('Rides'), tools: ['ride_carousel', 'ride_ferris_wheel', 'ride_bumper_cars', 'ride_swing', 'ride_haunted_house', 'ride_spiral_slide'] },
  { label: msg('Shops'), tools: ['shop_food', 'shop_drink', 'shop_toilet'] },
];
