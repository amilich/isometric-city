...
import { T, Currency, msg, useGT, useMessages } from 'gt-next';
                ...
                {category.tools.map(tool => {
                  ...
                  return (
                    <Button
                      ...
                      title={info.cost > 0 ? gt('{description} - {cost, number, ::currency/USD}', { description: m(info.description), cost: info.cost }) : m(info.description)}
                    >
