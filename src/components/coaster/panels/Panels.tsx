      ...
      <div className="space-y-2 text-sm">
        <T>
          <div className="flex items-center justify-between text-white/80">
            ...
            <Var><span className="text-green-300">{formatCurrency(finances.incomeAdmissions)}</span></Var>
          </div>
        </T>
        <T>
          <div className="flex items-center justify-between text-white/80">
            <span>Ride Tickets</span>
            <Var><span className="text-green-300">{formatCurrency(finances.incomeRides)}</span></Var>
          </div>
        </T>
        <T>
          <div className="flex items-center justify-between text-white/80">
            <span>Food & Drinks</span>
            <Var><span className="text-green-300">{formatCurrency(finances.incomeFood)}</span></Var>
          </div>
        </T>
        <T>
          <div className="flex items-center justify-between text-white/80">
            <span>Shops</span>
            <Var><span className="text-green-300">{formatCurrency(finances.incomeShops)}</span></Var>
          </div>
        </T>
      </div>
      ...
      <div className="border-t border-slate-800 pt-3 space-y-2 text-sm">
        <T>
          <div className="flex items-center justify-between text-white/70">
            <span>Upkeep</span>
            <Var><span className="text-red-300">{formatCurrency(finances.expenseUpkeep)}</span></Var>
          </div>
        </T>
        <T>
          <div className="flex items-center justify-between text-white/70">
            <span>Wages</span>
            <Var><span className="text-red-300">{formatCurrency(finances.expenseWages)}</span></Var>
          </div>
        </T>
      </div>
            ...
            <div className="space-y-2 text-sm">
              <T>
                <div className="flex justify-between text-muted-foreground">
                  <span>Park Name</span>
                  <Var><span className="text-foreground">{settings.name}</span></Var>
                </div>
              </T>
              <T>
                <div className="flex justify-between text-muted-foreground">
                  <span>Grid Size</span>
                  <Var><span className="text-foreground">{gridSize} x {gridSize}</span></Var>
                </div>
              </T>
              <T>
                <div className="flex justify-between text-muted-foreground">
