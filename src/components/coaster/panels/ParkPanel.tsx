      ...
      <ScrollArea className="flex-1 p-4">
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <div className="p-3 bg-white/5 rounded-lg text-center">
            <p className="text-2xl font-bold text-white"><Num>{guests.length}</Num></p>
            <T><p className="text-xs text-white/50">Guests</p></T>
          </div>
          <div className="p-3 bg-white/5 rounded-lg text-center">
            <p className="text-2xl font-bold text-white"><Num>{staff.length}</Num></p>
            <T><p className="text-xs text-white/50">Staff</p></T>
          </div>
          <div className="p-3 bg-white/5 rounded-lg text-center">
            <p className="text-2xl font-bold text-white"><Num>{openRides}</Num></p>
            <T><p className="text-xs text-white/50">Open Rides</p></T>
          </div>
          <div className="p-3 bg-white/5 rounded-lg text-center">
            <p className="text-2xl font-bold text-white"><Num>{rides.length}</Num></p>
