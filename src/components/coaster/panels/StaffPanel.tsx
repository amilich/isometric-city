...
import { T, Var, Currency, useGT, useMessages } from 'gt-next';
            ...
            {STAFF_DEFINITIONS.map((definition) => (
              ...
              >
                <div>
                  ...
                  <T><div className="text-[10px] text-muted-foreground"><Currency currency="USD">{definition.hiringFee}</Currency> hire</div></T>
                </div>
              </Button>
            ))}
          </div>
              ...
              {staff.map((member) => (
                <div key={member.id} className="flex items-start justify-between gap-2 text-sm">
                  ...
                  <div className="flex flex-col items-end gap-1 text-xs text-muted-foreground">
                    <T><div><Currency currency="USD">{member.wage}</Currency>/wk</div></T>
