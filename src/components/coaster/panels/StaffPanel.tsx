...
import { T, Var, Branch, useGT, useMessages } from 'gt-next';
            ...
            {STAFF_DEFINITIONS.map((definition) => (
              ...
              >
                <div>
                  ...
                  <div className="text-[10px] text-muted-foreground">{gt('{hiringFee} to hire', { hiringFee: '$' + definition.hiringFee })}</div>
                </div>
              </Button>
            ))}
          </div>
