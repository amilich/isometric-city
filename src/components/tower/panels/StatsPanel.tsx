      ...
      <DialogContent className="max-w-[520px]">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          <Card className="p-3">
            ...
            <div className="text-xs text-muted-foreground">{waveState === 'victory' ? gt('victory') : waveState.replace(/_/g, ' ')}</div>
          </Card>
          <Card className="p-3">
            ...
            <div className="text-xs text-muted-foreground">{gt('Spent {amount}', { amount: '$' + stats.moneySpent.toLocaleString() })}</div>
          </Card>
          <Card className="p-3">
            ...
            <div className="text-xs text-muted-foreground">{gt('Leaks {count}', { count: stats.leaks })}</div>
          </Card>
          <Card className="p-3">
