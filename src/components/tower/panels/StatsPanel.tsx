      ...
      <DialogContent className="max-w-[520px]">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
          <Card className="p-3">
            ...
            <div className="text-xs text-muted-foreground"><T><Var>{waveState === 'victory' ? 'victory' : waveState.replace(/_/g, ' ')}</Var></T></div>
          </Card>
          <Card className="p-3">
          ...
          <Card className="p-3">
            ...
            <div className="text-xs text-muted-foreground"><T>Leaks <Num>{stats.leaks}</Num></T></div>
          </Card>
          <Card className="p-3">
