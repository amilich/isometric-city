...
export function GameProvider({ children }: { children: React.ReactNode }) {
  ...
  const [state, setState] = useState<GameState>(() => createInitialGameState(DEFAULT_GRID_SIZE, 'BINANCECITY'));
  ...
  const newGame = useCallback((name?: string, size?: number) => {
    ...
    const fresh = createInitialGameState(size ?? DEFAULT_GRID_SIZE, name || 'BINANCECITY');
