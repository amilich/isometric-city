...
export const TOOL_INFO: Record<Tool, ToolInfo> = {
  ...
  rail: { name: 'Rail', cost: 50, description: 'Build rail tracks for trains' },
  ...
  rail_station: { name: 'Rail Station', cost: 1000, description: 'Rail network station', size: 1 },
...
export const BUILDING_STATS: Record<BuildingType, { maxPop: number; maxJobs: number; pollution: number; landValue: number }> = {
  ...
  rail: { maxPop: 0, maxJobs: 0, pollution: 3, landValue: -2 },
