...
export const TOOL_INFO: Record<Tool, ToolInfo> = {
  ...
  rail: { name: 'Rail', cost: 50, description: 'Rail tracks for trains' },
  ...
  rail_station: { name: 'Rail Station', cost: 1000, description: 'Train station for rail network', size: 1 },
...
export const BUILDING_STATS: Record<BuildingType, { maxPop: number; maxJobs: number; pollution: number; landValue: number }> = {
  ...
  rail: { maxPop: 0, maxJobs: 0, pollution: 3, landValue: 0 },
  ...
  rail_station: { maxPop: 0, maxJobs: 20, pollution: 2, landValue: 30 },
